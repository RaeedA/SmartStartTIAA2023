	  ...
	  {/* Get Name */}
        ...
        {this.state.showRealEstate && (
          <div style={realEstateMenuStyle}>``
            <button name = "apartment" onClick={this.handleRealEstate}>Apartment ($50k, earn $5k/Year)</button><br />
            <button name = "home" onClick={this.handleRealEstate}>Home (500k, earn 25k/Year)</button><br />
